...
* **Environment and scripts**
  ...
  The whole environment can be accessed in env/griffin.yaml in this repository. The environment can be directly built by
    ...
    &emsp;&emsp;LuCaP_TF.txt, lpWGS_TF.txt generated by scripts/collect_ichor_tf.py.
    ...
    Rscript Final_model.R   --train LuCaP_final_feature_matrix.tsv   --test clinic_final_feature_matrix.tsv   --labels LuCaP_subtypes.tsv   --tf_train LuCaP_TF.txt   --tf_test lpWGS_TF.txt   --healthy healthy_final_features.tsv   --folds 3 --repeats 3 --grid_size 25 --seed 2025   --gamma 0.5 --arpc_low_tf_q 0.30   --out_prefix results/clinic_predicted
    ```
* **Outputs**
